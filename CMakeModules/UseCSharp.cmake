  ...
  foreach( name ${target_name} )
    ...
    elseif (should_not_skip)
      ...
      add_custom_command(
        ...
        ARGS /t:${output_type} /out:${out} /doc:${out}.xml ${platform_param} ${CSBUILDFLAGS} ${CSHARP_SDK_COMPILER} ${separated_embd_resources} ${separated_sources} ${processed_refs} && mkdir -p ${out_dir}/../Mods/${modname} && cp -rf ${out} ${out_dir}/../Mods/${modname} | true && rsync -am --exclude "*.cs" --exclude "*.resx" --exclude ".\*" --exclude ".modignore" ${CMAKE_CURRENT_LIST_DIR}/${modname}/ ${out_dir}/../Mods/${modname}/ | true && cd ${out_dir}/../Mods/ && zip -r ${modname}-${mod_version}.zip ${modname} && rm -rf ${modname}
