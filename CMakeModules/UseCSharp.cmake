  ...
  foreach( name ${target_name} )
    ...
    elseif (should_not_skip)
      ...
      add_custom_command(
        ...
        ARGS /t:${output_type} /out:${out} /doc:${out}.xml ${platform_param} ${CSBUILDFLAGS} ${CSHARP_SDK_COMPILER} ${separated_embd_resources} ${separated_sources} ${processed_refs} && mkdir -p ${out_dir}/../Mods/${modname} && cp -rf ${out} ${CMAKE_CURRENT_LIST_DIR}/${modname}/* ${out_dir}/../Mods/${modname} |true && cd ${out_dir}/../Mods/ && find ${modname} -name '*.cs' -o -name '.*'  | xargs -n1 rm -rf && zip -r ${modname}-${mod_version}.zip ${modname} && rm -rf ${modname}
