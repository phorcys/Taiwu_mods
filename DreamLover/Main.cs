...
namespace DreamLover
{
	public static class Main
	{
		...
		public static void OnGUI(UnityModManager.ModEntry modEntry)
		{
			...
			GUILayout.Label("显示：");
			settings.菜单打开情况[0] = GUILayout.Toggle(settings.菜单打开情况[0], "被追求设置页");
			settings.菜单打开情况[1] = GUILayout.Toggle(settings.菜单打开情况[1], "情难自已设置页");
			settings.菜单打开情况[2] = GUILayout.Toggle(settings.菜单打开情况[2], "怀孕设置页");
			GUILayout.EndHorizontal();
			if (settings.菜单打开情况[0])
			{
